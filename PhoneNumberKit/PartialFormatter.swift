...
open class PartialFormatter {
    ...
    */
     ...
     */
    open func formatPartial(_ rawNumber: String) -> String {
        ...
        if finalNumber.characters.last == PhoneNumberConstants.separatorBeforeNationalNumber.characters.first {
            finalNumber = finalNumber.substring(to: finalNumber.characters.index(before: finalNumber.endIndex))
        }
    ...
    internal func isNanpaNumberWithNationalPrefix(_ rawNumber: String) -> Bool {
        ...
        return (rawNumber.characters.first == "1" && String(describing: rawNumber.characters.index(rawNumber.characters.startIndex, offsetBy: 1)) != "0" && String(describing: rawNumber.characters.index(rawNumber.characters.startIndex, offsetBy: 1)) != "1")
    }
